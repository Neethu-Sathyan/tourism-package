...
# Ensure HF_TOKEN is available within this script's environment
...
Xtrain_path = "hf://datasets/Neethu-Sathyan/tourism-project/Xtrain.csv"
Xtest_path = "hf://datasets/Neethu-Sathyan/tourism-project/Xtest.csv"
ytrain_path = "hf://datasets/Neethu-Sathyan/tourism-project/ytrain.csv"
ytest_path = "hf://datasets/Neethu-Sathyan/tourism-project/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "/content/drive/MyDrive/GreatLearning/Advanced  machine learning and MLOPS/Assessment/tourism_project/model_building/best_tourism_model_v1.joblib"
    ...
    repo_id = "Neethu-Sathyan/tourism-model"
    repo_type = "model"
    ...
    api.upload_file(
        path_or_fileobj="model_building/best_tourism_model_v1.joblib",
